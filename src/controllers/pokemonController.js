...
// ============================================
// VIEW CONTROLLERS (render HTML via EJS)
// ============================================

/**
 * Home page: paginated grid of all Pokemon.
 */
...
/**
 * Detail page for a single Pokemon.
 */
...
/**
 * Search results page (reuses the index grid).
 */
...
/**
 * Type-filtered page (reuses the index grid).
 */
